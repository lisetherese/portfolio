...
(function() {
  ...
  /**
   * Button tableau synthese
   */
   let tableau = select('.tableau')
   if (tableau) {
     const toggleTableau = () => {
       if (window.scrollY > 70) {
         tableau.classList.add('active')
       } else {
         tableau.classList.remove('active')
       }
     }
     window.addEventListener('load', toggleTableau)
     onscroll(document, toggleTableau)
   }
